...
var App = /** @class */ (function () {
    ...
    App.prototype.getCustomControls = function () {
        ...
        var targetContent = new _1.DOMControl(Control_1.ControlType.TARGET);
        return [
            new _1.DOMControl(Control_1.ControlType.ROTATE, 0, 0, 0, 0, 30),
            new _1.DOMControl(Control_1.ControlType.ROTATE, 0, 1, 0, 0, 30),
            new _1.DOMControl(Control_1.ControlType.ROTATE, 1, 0, 0, 0, 30),
            new _1.DOMControl(Control_1.ControlType.ROTATE, 1, 1, 0, 0, 30),
            targetContent,
            translater,
            new _1.DOMControl(Control_1.ControlType.BORDER),
            new _1.DOMControl(Control_1.ControlType.REGISTRATION, .5, .5, 0, 0, 10),
            new _1.DOMControl(Control_1.ControlType.SKEW_Y, 0, .5, 0, 0, 10),
            new _1.DOMControl(Control_1.ControlType.SCALE_X, 1, .5, 0, 0, 10),
            new _1.DOMControl(Control_1.ControlType.SKEW_X, .5, 0, 0, 0, 10),
            new _1.DOMControl(Control_1.ControlType.SCALE_Y, .5, 1, 0, 0, 10),
            new _1.DOMControl(Control_1.ControlType.SCALE, 0, 0, 0, 0, 10),
            new _1.DOMControl(Control_1.ControlType.SCALE, 0, 1, 0, 0, 10),
            new _1.DOMControl(Control_1.ControlType.SCALE, 1, 0, 0, 0, 10),
            new _1.DOMControl(Control_1.ControlType.SCALE, 1, 1, 0, 0, 10),
            new _1.DOMControl(Control_1.ControlType.ROTATE_SCALE, 1, 0, 15, -15, 10),
            new _1.DOMControl(Control_1.ControlType.SCALE_UNIFORM, 1, 1, 15, 15, 10),
            new _1.DOMControl(Control_1.ControlType.ROTATE, .5, 0, 0, -20)
        ];
    };

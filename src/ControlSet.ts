...
export default class ControlSet {
    ...
    static getUniformScaler () {
        ...
        return [
            ...
            new this.controlClass(ControlType.SCALE_UNIFORM, 0,0, 0,0, 10),
            new this.controlClass(ControlType.SCALE_UNIFORM, 0,1, 0,0, 10),
            new this.controlClass(ControlType.SCALE_UNIFORM, 1,0, 0,0, 10),
            new this.controlClass(ControlType.SCALE_UNIFORM, 1,1, 0,0, 10)
        ];	
    }
